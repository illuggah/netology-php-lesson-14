	...
	<nav class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand">TODO | Sign Up</a>

			</div>
			<div class="navbar-collapse navbar-top collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="log_in.php">Вход</a></li>
					<li class="active"><a href="sign_up.php">Регистрация</a></li>
				</ul>
			</div>
		</div>
	</nav>
			...
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
	                    ...
	                    <a href="log_in.php" style="margin-top: 16px;" class="btn btn-warning btn-block">Войти</a>
	                </div>
	            </div>
	        </div>
	    </div>
